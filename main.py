...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.root.tk.call("wm", "iconphoto", self.root._w, PhotoImage(file="C:\\Users\\mhmts\\PycharmProjects\\Pomodoro Timer\\Tomato-22-2-1024x1001.png"))
        ...
        self.pomodoro_timer_label = ttk.Label(self.tab1, text="25:00", font=("Ubuntu", 47))
        self.pomodoro_timer_label.pack(padx=20)

        self.short_break_timer_label = ttk.Label(self.tab2, text="05:00", font=("Ubuntu", 47))
        self.short_break_timer_label.pack(padx=20)

        self.long_break_timer_label = ttk.Label(self.tab3, text="20:00", font=("Ubuntu", 47))
        self.long_break_timer_label.pack(padx=20)
